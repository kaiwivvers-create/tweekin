...
<div class="w-full flex">
    ...
    <div class="flex-1 px-6 sm:px-8 lg:px-12 py-8 sm:py-12">
        ...
        <div class="mb-8 animate-fade-in">
            ...
            <p class="text-warm-500 leading-relaxed">Pick the closest match, or go with "Not sure" if you'd rather describe it yourself.</p>
        </div>

        <form id="physical-form" action="{{ route('physical.questions') }}" method="GET" class="space-y-3 stagger-children">
            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="fever" class="peer hidden" required>
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    ...
                    <div class="w-5 h-5 rounded-full border-2 border-physical-200 peer-checked:border-physical-500 shrink-0 flex items-center justify-center transition-colors">
                        <div class="w-2.5 h-2.5 rounded-full bg-physical-500 scale-0 peer-checked:scale-100 transition-transform"></div>
                    </div>
                </div>
            </label>

            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="pain" class="peer hidden">
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    <div class="w-8 h-8 rounded-lg bg-physical-100 border border-physical-200 flex items-center justify-center shrink-0">
            ...
            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="skin" class="peer hidden">
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    <div class="w-8 h-8 rounded-lg bg-physical-100 border border-physical-200 flex items-center justify-center shrink-0">
            ...
            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="respiratory" class="peer hidden">
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    <div class="w-8 h-8 rounded-lg bg-physical-100 border border-physical-200 flex items-center justify-center shrink-0">
            ...
            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="digestive" class="peer hidden">
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    <div class="w-8 h-8 rounded-lg bg-physical-100 border border-physical-200 flex items-center justify-center shrink-0">
            ...
            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="fatigue" class="peer hidden">
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    <div class="w-8 h-8 rounded-lg bg-physical-100 border border-physical-200 flex items-center justify-center shrink-0">
            ...
            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="other" class="peer hidden">
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    <div class="w-8 h-8 rounded-lg bg-physical-100 border border-physical-200 flex items-center justify-center shrink-0">
            ...
            <label class="block cursor-pointer">
                <input type="radio" name="symptom" value="unsure" class="peer hidden">
                <div class="flex items-center gap-4 p-4 rounded-xl border-2 border-warm-200 bg-white peer-checked:border-physical-400 peer-checked:bg-physical-50 hover:border-warm-300 hover:bg-warm-50 transition-all duration-200">
                    <div class="w-8 h-8 rounded-lg bg-physical-100 border border-physical-200 flex items-center justify-center shrink-0">
                        <svg class="w-4 h-4 text-physical-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    </div>
...
<script>
    document.querySelectorAll('input[name="symptom"]').forEach(radio => {
        radio.addEventListener('change', () => {
            document.getElementById('physical-submit').disabled = false;
            document.getElementById('not-sure-input').classList.toggle('hidden', radio.value !== 'unsure');
        });
    });
</script>
@endsection
